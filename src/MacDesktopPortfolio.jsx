...
const SKILLS = {
  ...
  Security: [
    { name: "Bot Detection", level: 88 },
    { name: "OWASP / Pen Testing", level: 75 },
    { name: "OAuth / JWT", level: 85 },
    { name: "Web Crypto API", level: 72 },
  ],
  Infrastructure: [
      ...
      <div style={{
        ...
        <div>
          ...
          <p style={{
            ...
            Full Stack Developer • MERN Stack • Web Security
          </p>
...
<div style={{ marginBottom: 24 }}>
  ...
  <div style={{
    ...
    <div style={{
      ...
      Problems Solved: 117+ <br/>
      Contest Rating: 1540 <br/>
      Global Rank: Top 35% approx <br/>
    ...
    >
      ...
      <div>
        ...
        {[
          {
            year: "2026",
            event: "Focused on MERN stack development, web security, and full-stack projects"
          },
          {
            year: "2025",
            event: "Built JaanRaksha and PUBLIC THREAD full-stack applications"
          },
          {
            year: "2024",
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div>
          → 5★ rating in C++ on GeeksforGeeks  
          <br />
